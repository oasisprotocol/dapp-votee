...
export interface NativeBalanceACLInterface extends Interface {
  getFunction(
    nameOrSignature:
      | 'canCreatePoll'
      | 'canManagePoll'
...
export interface NativeBalanceACL extends BaseContract {
  connect(runner?: ContractRunner | null): NativeBalanceACL
  waitForDeployment(): Promise<this>

  interface: NativeBalanceACLInterface
  ...
  canManagePoll: TypedContractMethod<
    [in_pm: AddressLike, in_proposalId: BytesLike, in_who: AddressLike],
    [boolean],
    'view'
  >

  canVoteOnPoll: TypedContractMethod<
    [in_pm: AddressLike, in_proposalId: BytesLike, who: AddressLike, arg3: BytesLike],
    [bigint],
    'view'
  >

  onPollClosed: TypedContractMethod<[in_proposalId: BytesLike], [void], 'nonpayable'>

  onPollCreated: TypedContractMethod<
    [in_proposalId: BytesLike, in_creator: AddressLike, in_data: BytesLike],
    [void],
    'nonpayable'
  >
  ...
  ): TypedContractMethod<[in_proposalId: BytesLike], [void], 'nonpayable'>
  getFunction(
